...
/**
 * Application classification types — mirrors C++ DPI::AppType enum class.
 * Detected primarily via TLS SNI (Server Name Indication).
 */
public enum AppType {
    UNKNOWN,
    HTTP,
    ...
    /** Human-readable label, mirrors appTypeToString() in types.cpp */
    public String label() {
        return switch (this) {
    ...
    /**
     * Maps an SNI string to an AppType.
